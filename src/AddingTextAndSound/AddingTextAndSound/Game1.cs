...
/// Load fonts and use them to show the score on screen.
/// Play a sound whenever the user destroys an enemy.
namespace AddingTextAndSound
{
    /// <summary>
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        #region Step 04
        int mousePointerTextureWidth, mousePointerTextureHeight;
        #endregion

        /// Font to be used when displaying the score.
        SpriteFont kootenay32Font;
        ...
        protected override void LoadContent()
        {
            ...
            #region Step 04
            this.mousePointerTextureWidth = this.mousePointerTexture.Width;
            this.mousePointerTextureHeight = this.mousePointerTexture.Height;
            #endregion

            /// In this case, we are loading an asset from the Content project,
            /// but it is a SpriteFont instead of a Texture2D.
            kootenay32Font = Content.Load<SpriteFont>(@"Fonts\Kootenay32");

            /// In this case, we are loading an asset from the Content project,
            /// but it is a SoundEffect instead of a Texture2D.
            shotSoundEffect = Content.Load<SoundEffect>(@"Sounds\ShotSoundEffect");
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            mousePointerPosition = new Vector2(mouseState.X, mouseState.Y);
            #endregion
            ...
            #region Step 04
            /// Checks if we are pressing the left button of the mouse.
            /// If this is the case, then it will check if the mouse was above one of the enemies and
            /// destroy it.
            if (mouseState.LeftButton == ButtonState.Pressed)
            {
                for (int index = this.enemies.Count - 1; index >= 0; index--)
                {
                    /// Checks if the rectangle containing the enemy texture is collapsing with the
                    /// rectangle containing the mouse pointer texture.
                    if (this.enemies[index].Intersects(
                        new Rectangle((int)this.mousePointerPosition.X, (int)this.mousePointerPosition.Y, this.mousePointerTextureWidth, this.mousePointerTextureHeight)))
                    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            this.spriteBatch.DrawString(kootenay32Font, "Score: " + score, new Vector2(15, 15), Color.White);
        ...
        ///     Plays a sound.
        /// </summary>
        /// <param name="index"> Index inside the enemy collection of the killed enemy. </param>
